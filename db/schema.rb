...
ActiveRecord::Schema[7.0].define(version: 2024_08_29_213412) do
  ...
  create_table "custom_fields", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["client_id", "internal_name"], name: "index_custom_fields_on_client_id_and_internal_name", unique: true
