...
custom5= CustomField.create( label: "haunted", internal_name: "haunted", client: c3, field_type: :enumerator)
custom6= CustomField.create( label: "Number of Bedrooms", internal_name: "num_bedrooms", client: c4, field_type: :number)
custom6= CustomField.create( label: "Good Deal!!", internal_name: "good_deal", client: c4, field_type: :enumerator)
custom6= CustomField.create( label: "Pet Friendly", internal_name: "pet_friendly", client: c4, field_type: :enumerator)
custom6= CustomField.create( label: "square feet", internal_name: "square feet", client: c5, field_type: :number)
custom6= CustomField.create( label: "notes", internal_name: "notes", client: c5, field_type: :freeform)
